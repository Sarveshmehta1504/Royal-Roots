...
# ── Flask ────────────────────────────────────────────────────────────────────
# In Netlify functions, this file is inside netlify/functions/backend/
CURRENT_DIR = os.path.abspath(os.path.dirname(__file__))
# current dir is: /var/task/dist/netlify/functions/backend, root is 3 levels up
...
if __name__ == '__main__':
    print("=" * 60)
    print("🚀 ROYAL ROOTS PRODUCTION SERVER — Launch Ready")
    print("   Homepage   → http://127.0.0.1:8000")
    print("   Admin CMS  → http://127.0.0.1:8000/admin")
    print("=" * 60)
